...
description: "O tempo realmente voa. 10 anos já se passaram desde que deixei as terras tupiniquins e decidi encarar os frios invernos canadenses. Trago aqui algumas reflexões sobre o mercado, ambiente de trablho, cultura e as diferenças que pude perceber ao longo destes 10 anos."
images: []
resources:
- name: "featured-image"
...
![Packer](meme-vagas.png)

Apesar do meme humorístico, esta foi basicamente a impressão que tive ao chegar aqui em 2015.
...
1- Ele estava usando um chapéu de bobo da corte;
2- O carrinho que ele vinha empurrando estava cheio de bebidas: cervejas, vinhos, licores, etc.
